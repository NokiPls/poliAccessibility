	...
	<div id="header">
		...
		<nav id="nav" role="navigation">
			<ul>
				...
				<li><a
					href="${pageContext.request.contextPath}/switchFont?font=${font}&page=orderSuccess"
					title="Switch
						to ${font} font">Switch to ${font} font</a></li>
				<li><a
					href="${pageContext.request.contextPath}/switchContrast?contrast=${contrast}&page=orderSuccess"
					title="Switch
